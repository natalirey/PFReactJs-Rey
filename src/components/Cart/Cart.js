...
const Cart = () => {
    ...
    return (
        <div>
          ...
          <Link to="/">
          <img src={back} title="Volver atras" alt="volver" className="w-8 cursor-pointer "/></Link>
          <img onClick={()  => clearCart()} src={trash} alt="vaciar carrito" title="Limpiar carrito" className=" w-8 cursor-pointer"/>
          </div>
